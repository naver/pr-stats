...
describe("PRList > averageCommentCount", () => {
    it("특정 PR 목록에서 PR당 리뷰어가 남긴 코멘트 수의 평균을 구할 수 있어야 한다.", () => {
        // given
        ...
        // when
        const result = averageCommentCount([prStats1, prStats2, prStats3]);
        const commentCount1 = 2;
        const commentCount2 = 1;
        const commentCount3 = 1;
